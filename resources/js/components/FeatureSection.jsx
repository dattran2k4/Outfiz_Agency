                ...
                <div className="flex flex-col lg:flex-row items-center gap-[52px]">
                    ...
                    <div className="w-full lg:w-1/2 text-left">
                        ...
                        <p className="text-[#404040] leading-[4/3] mt-6 mb-8 text-justify md:text-left">
                            Không chỉ là một đơn vị thực thi marketing, Outfiz
                            Agency là đối tác chiến lược giúp doanh nghiệp bạn
                            phát triển thương hiệu bài bản, tối ưu hiệu suất và
                            tạo ra giá trị thực từ ngân sách đầu tư.
                        </p>
                    </div>
                </div>
            </div>
