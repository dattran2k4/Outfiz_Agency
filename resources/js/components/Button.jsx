...
const Button = ({ 
  ...
  const baseStyles = "flex items-center justify-center gap-[4px] rounded-[30px] transition-all duration-300 pt-[10px] pb-[10px] px-[16px] cursor-pointer";
  ...
  return (
    <button 
      className={`${baseStyles} ${variants[variant]} ${className} ${defaultWidth}`} 
      {...props}
    >
      {/* Icon  */}
