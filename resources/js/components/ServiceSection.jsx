        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-5">
          ...
          <div className="flex flex-col justify-center pr-0 md:pr-8">
            ...
            <div className="text-gray-600 leading-relaxed space-y-4 text-justify md:text-left">
              ...
              <p>
                Với đội ngũ sáng tạo, chuyên môn cao và quy trình triển khai rõ ràng, OUTFIZ cam kết đồng hành cùng bạn từ chiến lược đến hành động cụ thể và mang lại giá trị thực, kết quả thật.
              </p>
            </div>
          </div>
...
const ServiceCard = ({data}) => {
    return  (
        <article className="bg-white rounded-[15px] p-6 shadow-lg hover:shadow-2xl transition-all 
        duration-300 hover:-translate-y-2 border border-[#D4D4D4] group flex flex-col items-center text-center h-full">
            ...
            {/* Title */}
            <h3 className="text-3xl leading-5 text-[#404040] font-bold mt-8">
                    {data.title}
            </h3>
            {/* Description */}
            <p className="text-lg text-[#404040] mt-5 leading-[4/3] line-clamp-1">
                {data.description}
            </p>
            {/* Button */}
            <div className="mt-7">
